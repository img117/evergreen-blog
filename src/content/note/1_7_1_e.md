...
[
    {
        "sshUrl": "git@github.com:rolemadelen/minimalist-blog.git"
    },
    {
        "sshUrl": "git@github.com:rolemadelen/portfolio_v2.git"
    },
    {
        "sshUrl": "git@github.com:rolemadelen/rolemadelen.github.io.git"
    },
    ...
]
```
...
Here's the output.
```text
git@github.com:rolemadelen/minimalist-blog.git
git@github.com:rolemadelen/portfolio_v2.git
git@github.com:rolemadelen/rolemadelen.github.io.git
```
...
```sh
git clone git@github.com:rolemadelen/minimalist-blog.git
git clone git@github.com:rolemadelen/portfolio_v2.git
git clone git@github.com:rolemadelen/rolemadelen.github.io.git
```